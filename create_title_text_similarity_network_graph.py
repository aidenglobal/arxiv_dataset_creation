...
# Ideally we place functions in a "utils.py" file and import them here, but for simplicity we define them here
...
edge_df = pd.DataFrame(flattened_results, columns=['Source', 'Target', 'Weight']).sort_values(by='Weight', ascending=False).drop_duplicates()
